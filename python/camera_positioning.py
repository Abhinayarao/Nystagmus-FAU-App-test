# UPDATED VERSION v5
# Features:
# - Symmetry-aware horizontal centering
# - Horizontal center based on eye polygons
# - Each text has its own small semi-transparent white box
...
# ---------------- USER PARAMETERS ----------------
INPUT_VIDEO = "/content/drive/MyDrive/Dataset/3 April/IMG_3038.MOV"
...
while cap.isOpened():
    ...
    if results.multi_face_landmarks:
        ...
        residual_dx = dx_L + dx_R  # canceling offsets
        horiz_pct = max(0, 100 * (1 - abs(residual_dx) / (w/2)))  # scale by half screen width
...
print("Processing complete. Output:", OUTPUT_VIDEO)
